...
- `update_task` on this API needs the task's `projectId` and `position` preserved — read them first.
...
## 6. Confirm before destructive or bulk actions
...
- Did I search for an existing task?
