...
- Completes the sentence "This task will ___".
...
- [ ] Condition 2
(Keep ≤ 8. Each must be verifiable — someone can check it's true.)

## Technical notes
Verified references only (see grounding.md §5): endpoints, files, tables, components, configs.
...
checklist of subtasks inside the acceptance criteria.
